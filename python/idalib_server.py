...
mcp = FastMCP("github.com/sigwl/AiDA#idalib")

def fixup_tool_argument_descriptions(mcp: FastMCP):
    # In our tool definitions within `AiDA_MCP.py`, we use `typing.Annotated` on function parameters
...
def main():
    ...
    plugin = importlib.import_module("AiDA_MCP")
