...
class Server:
    ...
    def start(self):
        if self.running:
            print("[AiDA-MCP] Server is already running")
            return
...
class MCP(idaapi.plugin_t):
    ...
    comment = "AiDA-MCP Plugin"
    help = "AiDA-MCP"
    wanted_name = "AiDA-MCP"
    ...
    def init(self):
        ...
        print(f"[AiDA-MCP] Plugin loaded, use Edit -> Plugins -> AiDA-MCP ({hotkey}) to start the server")
