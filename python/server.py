...
mcp = FastMCP("github.com/sigwl/AiDA", log_level="ERROR")
...
IDA_PLUGIN_PY = os.path.join(SCRIPT_DIR, "AiDA_MCP.py")
...
def install_ida_plugin(*, uninstall: bool = False, quiet: bool = False):
    ...
    plugin_destination = os.path.join(ida_plugin_folder, "AiDA_MCP.py")
    if uninstall:
